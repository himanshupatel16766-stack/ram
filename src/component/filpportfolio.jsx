...
export default function FlipPortfolio() {
  ...
  const pages = [
    ...
    },
    {
      title: "About",
      body:
        "Hi — I'am Himanshu. I am an AI engineer who designs, builds, and improves intelligent systems that solve real-world problems using data and machine learning.",
    },
    {
      title: "Project — stone-paper-scissor game",
      project: {
    ...
    {
      title: "Skills",
      bullets: ["python", "c++",  "GIT"],
    },
    {
      title: "Contact",
      contact: {
        email: "himanshupatel16766@gmail.com",
        phone: "+91-6267652244",
        linkedin: "https://www.linkedin.com/in/himanshu-patel-763b33298?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app",
      },
    },
    {
      title: "Education",
      contact: {
        college: "shushila devi bansal college of engineering",
        branch: "AIML",
      },
    },
    {
